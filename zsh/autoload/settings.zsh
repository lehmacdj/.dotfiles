...
# Use fcntl locking when writing history; safer with concurrent shells
setopt hist_fcntl_lock
HISTSIZE=10000000
SAVEHIST=10000000
HISTFILE="${XDG_STATE_HOME:-$HOME/.local/state}/zsh/history"
HISTORY_IGNORE="(ls|ll|bg|fg)"
# this causes HISTORY_IGNORE to be applied whenever writing
# thus adding to history ignore can delete entires that were previously saved
